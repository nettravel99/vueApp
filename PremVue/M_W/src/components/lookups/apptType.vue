<template>
  <div>
    ...
    <el-dialog :title="'Appointment Codes Lookup'" :visible.sync="dialogFormVisible" append-to-body>
      <el-row>
        <el-col :span="24">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      data: [],
      headers: ['id', 'Code', 'Description', 'Length'],
      hiddenColumns: {
        columns: [0]
      },
      colWidths: [40, 170, 550, 180],
  ...
  methods: {
    ...
    async initLookup() {
      const data = await M('apptType^MWLK')
